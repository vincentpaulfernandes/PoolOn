...
const style = {
  wrapper: `h-16 w-full bg-blue-500 text-white flex md:justify-around items-center px-60 fixed z-20`,
  leftMenu: `flex gap-3`,
...
const Navbar = () => {
  const { currentAccount, connectWallet, currentUser, disconnectWallet } = useContext(UberContext)

  return (
    <div className={style.wrapper}>
      <div className={style.leftMenu}>
        <div className={style.logo}>PoolUs</div>
